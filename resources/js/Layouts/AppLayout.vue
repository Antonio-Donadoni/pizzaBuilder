                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                <jet-nav-link :href="route('PizzaBuilder')" :active="route().current('PizzaBuilder')">
                                    Pizza Builder 
                                </jet-nav-link>
                            </div>
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                <jet-nav-link :href="route('OrderHistory')" :active="route().current('OrderHistory')">
                                    I tuoi ordini
                                </jet-nav-link>
                            </div>
                        </div>
